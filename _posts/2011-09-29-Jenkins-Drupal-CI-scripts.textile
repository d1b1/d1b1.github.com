...
2. drupal_full.sh - This script will run all three of the test; syntax, coding standards and simpletest. Additionally this script has jenkins parameters added to allow the job to alter the testing information for each job. 
